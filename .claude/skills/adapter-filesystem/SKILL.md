...
| `FileExistsException` | Defined, never thrown — `grep -rn "FileExistsException" src/ tests/` finds only the class declaration (`src/Exception/FileExistsException.php:10`), 0 `throw` sites |
