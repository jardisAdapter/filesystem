...
[![No Third-Party Dependencies](https://img.shields.io/badge/Dependencies-No%20Third--Party-brightgreen.svg)](composer.json)
...
Filesystem (Orchestrator)
  ...
  │   + 17 atomic handlers: LocalRead, LocalWrite, LocalExists, ...
  │
  └── S3:
      S3Signer (AWS Signature v4)
      S3Request (shared cURL helper)
      + 18 atomic handlers: S3Read, S3Write, S3Exists, ...
```
